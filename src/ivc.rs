use ark_std::{rand::Rng, marker::PhantomData};
use ark_ff::PrimeField;
use proof_essentials::vector_commitment::HomomorphicCommitmentScheme;

use crate::{
    folding_scheme, NonInteractiveFoldingScheme, PLONKFoldingScheme, RelaxedPLONKInstance,
    RelaxedPLONKWitness, StepCircuit, IVC,
};
...
pub trait SangriaIVCConfig<MainField: PrimeField, HelperField: PrimeField> {
    type MainCommitmentSelectors: HomomorphicCommitmentScheme<MainField>;
    type MainCommitmentWitness: HomomorphicCommitmentScheme<MainField>;

    type HelperCommitmentSelectors: HomomorphicCommitmentScheme<HelperField>;
    type HelperCommitmentWitness: HomomorphicCommitmentScheme<HelperField>;
}
...
pub(crate) struct PublicParameters<
    ...
    Config: SangriaIVCConfig<MainField, HelperField>,
> {
    pub main_nifs_pp: folding_scheme::PublicParameters<
        MainField,
        Config::MainCommitmentSelectors,
        Config::MainCommitmentWitness,
    >,
    pub helper_nifs_pp: folding_scheme::PublicParameters<
        HelperField,
        Config::HelperCommitmentSelectors,
        Config::HelperCommitmentWitness,
    >,
}
...
pub(crate) struct VerifierKey<
    ...
    SC: StepCircuit<MainField>,
> {
    pub main_nifs_vk: folding_scheme::VerifierKey<MainField, Config::MainCommitmentSelectors>,
    pub helper_nifs_vk: folding_scheme::VerifierKey<HelperField, Config::HelperCommitmentSelectors>,
    pub step_circuit: SC,
}
...
pub(crate) struct ProverKey<
    ...
    SC: StepCircuit<MainField>,
> {
    pub main_nifs_pk: folding_scheme::ProverKey<
        MainField,
        Config::MainCommitmentSelectors,
        Config::MainCommitmentWitness,
    >,
    pub helper_nifs_pk: folding_scheme::ProverKey<
        HelperField,
        Config::HelperCommitmentSelectors,
        Config::HelperCommitmentWitness,
    >,
...
pub(crate) struct HalfCycleProof<F: PrimeField> {
    pub latest_step_instance: RelaxedPLONKInstance<F>,
    pub latest_step_witness: RelaxedPLONKWitness<F>,
    pub running_instance: RelaxedPLONKInstance<F>,
...
pub(crate) struct IVCProof<MainField: PrimeField, HelperField: PrimeField> {
    pub main_half_proof: HalfCycleProof<MainField>,
    pub helper_half_proof: HalfCycleProof<HelperField>,
}
    ...
    SC: StepCircuit<MainField>,
{
    ...
    type Proof = IVCProof<MainField, HelperField>;
